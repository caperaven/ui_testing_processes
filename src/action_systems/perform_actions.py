...
class PerformActions:
    ...
    async def navigate(step, context, process, item):
        ...
        if "wait" in step["args"]:
            await wait(context.driver, step["args"])
    ...
    async def close_window(step, context, process, item):
        await close_window(context.driver, step["args"], process["_results"])
    ...
    async def click(step, context, process, item):
        await click(context.driver, step["args"], process["_results"])
    ...
    async def dbl_click(step, context, process, item):
        await dbl_click(context.driver, step["args"], process["_results"])
    ...
    async def context_click(step, context, process, item):
        await context_click(context.driver, step["args"], process["_results"])
    ...
    async def click_sequence(step, context, process, item):
        await click_sequence(context.driver, step["args"], process["_results"])
    ...
    async def press_key(step, context, process, item):
        await press_key(context.driver, step["args"], process["_results"])
    ...
    async def print_screen(step, context, process, item):
        await print_screen(context.driver, step["args"], process["_results"])
    ...
    async def select_option(step, context, process, item):
        await select_option(context.driver, step["args"], process["_results"])
    ...
    async def switch_to_frame(step, context, process, item):
        await switch_to_frame(context.driver, step["args"], process["_results"])
    ...
    async def switch_to_default(step, context, process, item):
        await switch_to_default(context.driver, step["args"], process["_results"])
    ...
    async def switch_to_tab(step, context, process, item):
        await switch_to_tab(context.driver, step["args"], process["_results"])
    ...
    async def type_text(step, context, process, item):
        await type_text(context.driver, step["args"], process["_results"])
    ...
    async def drag_by(step, context, process, item):
        await drag_by(context.driver, step["args"], process["_results"])
    ...
    async def hover_over_element(step, context, process, item):
        await hover_over_element(context.driver, step["args"], process["_results"])
    ...
    async def mouse_drag(step, context, process, item):
        await mouse_drag(context.driver, step["args"], process["_results"])
